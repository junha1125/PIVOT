...
from llava.mm_utils import process_images_half_cuda as process_images
...
def process(line, args, tokenizer, image_processor, model_config):
    ...
    if line["filename"] is None:
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to load image at {img_path}. Did you download from https://huggingface.co/datasets/nyu-visionx/CV-Bench/tree/main? \
                \nPlease refer to original code (https://github.com/cambrian-mllm/cambrian/blob/main/eval/eval/omni/omni_eval.py)"
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--images_path", type=str, default="CV_Bench_3D") # Path of CV_Bench_3D. https://huggingface.co/datasets/nyu-visionx/CV-Bench/tree/main
    parser.add_argument("--prompt_path", type=str, default="CV_Bench_3D/test_3d.jsonl") # Path of test_3d.jsonl
