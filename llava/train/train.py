...
class ModelArguments:
    ...
    vision_source_mllm_path: Optional[str] = field(default=None) # used for PIVOT
    mm_projector_source_load_layers: int = field(default=0, metadata={"help": "Number of projector linear layers to load from source MLLM (0=random init, 1=first layer only, 2=both layers)"})
    vision_tower_pretrained: Optional[str] = field(default=None)  # used for eva_vit.py
