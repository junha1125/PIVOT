...
class DinoVisionTower(BaseVisionTower):
    def __init__(self, vision_tower, args, delay_load=False):
        ...
        #         rank0_print(f"Extracted image size {self._image_size} from passed model name '{self.vision_tower_name}' (using {parts[0]})")
    ...
    def load_model(self, device_map=None):
        ...
        if self._image_size is None:
            ...
            rank0_print(f"Overriding DinoVisionTower image size of {_image_size} with {self._image_size}")
        ...
        rank0_print(f"Dino Vision Processor: {processor}")
